...
(() => {
    ...
    function initReveals() {
        const items = Array.from(document.querySelectorAll(".section__inner, .card, .profile-panel, .profession-card, .result-card")).filter((item) => !item.closest("[data-landing-story]"));
